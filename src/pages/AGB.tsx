  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-8 py-20">
        ...
        <h1 className="font-black text-4xl md:text-5xl uppercase tracking-tight mb-4">AGB</h1>
        ...
        <div className="space-y-10 text-gray-600 leading-relaxed">
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">1. Geltungsbereich</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">2. Leistungsbeschreibung</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">3. Provision</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">4. Vertraulichkeit</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">5. Haftung</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">6. Waren und MHD</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">7. Zahlungsbedingungen</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">8. Anwendbares Recht</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">9. Salvatorische Klausel</h2>
            <p>
