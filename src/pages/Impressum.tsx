  ...
  return (
    <div className="bg-[#ffffff] min-h-screen">
      <div className="max-w-3xl mx-auto px-8 py-20">
        ...
        <h1 className="heading-display text-4xl md:text-5xl mb-4">Impressum</h1>
        <div className="h-1 w-16 bg-[#8cc63f] mb-12"></div>

        <div className="space-y-10 text-gray-600 leading-relaxed">
          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Angaben gem&auml;&szlig; &sect; 5 ECG / &sect; 25 MedienG</h2>
            <p className="font-bold text-black">HELLO SECOND/RUN.</p>
            <p>Angebots-Tool f&uuml;r Sonderposten</p>
            <p className="mt-2">Alen M.</p>
            <p>Salzburg, &Ouml;sterreich</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Kontakt</h2>
          ...
          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Unternehmensgegenstand</h2>
            <p>Bereitstellung eines digitalen Tools zur Erstellung von Sonderposten-Angeboten, Preisrecherche und Dokumentengenerierung f&uuml;r den DACH-Raum.</p>
          </section>

          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Haftungsausschluss</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Urheberrecht</h2>
            <p>
          ...
          <section>
            <h2 className="font-semibold text-lg text-[#111113] mb-3">Streitschlichtung</h2>
            <p>
              Die Europ&auml;ische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit:{' '}
              <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer" className="text-[#111113] hover:text-[#8cc63f] transition-colors font-medium">
