  ...
  return (
    <div className="bg-white min-h-screen">
      <div className="max-w-3xl mx-auto px-8 py-20">
        ...
        <h1 className="font-black text-4xl md:text-5xl uppercase tracking-tight mb-4">Datenschutz</h1>
        <div className="h-1 w-16 bg-[#8cc63f] mb-12"></div>

        <div className="space-y-10 text-gray-600 leading-relaxed">
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">1. Datenschutz auf einen Blick</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">2. Verantwortliche Stelle</h2>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">3. Datenerfassung auf unserer Website</h2>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">4. Authentifizierung</h2>
            <p>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">5. Ihre Rechte (DSGVO)</h2>
            ...
            <p className="mt-4">
              ...
              <a href="mailto:info@hello2ndrun.com" className="text-[#1a472a] hover:text-[#8cc63f] transition-colors font-medium">info@hello2ndrun.com</a>
            </p>
          </section>

          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">6. Beschwerderecht</h2>
            <p>
              Sie haben das Recht, sich bei der &ouml;sterreichischen Datenschutzbeh&ouml;rde zu beschweren:{' '}
              <a href="https://www.dsb.gv.at" target="_blank" rel="noopener noreferrer" className="text-[#1a472a] hover:text-[#8cc63f] transition-colors font-medium">
                www.dsb.gv.at
              </a>
            </p>
          </section>
          ...
          <section>
            <h2 className="font-black text-lg uppercase tracking-tight text-black mb-3">7. Hosting</h2>
            <p>
